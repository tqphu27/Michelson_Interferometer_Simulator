...
class MichelsonSimulation:
    ...
    # set M1 direction mirror(i.e. set its central point)
    def setMirrorM1_dir(self, loc):
        locVector = np.array(loc)
        self.mirror_M1[0] = locVector

    # set M2 direction mirror(i.e. set its central point)
    def setMirrorM2_dir(self, loc):
        locVector = np.array(loc)
    ...
    def moveMirrorM1_dir(self, movement):
    ...
    # move M2 direction mirror(i.e. move its central point)
    def moveMirrorM2_dir(self, movement):
        movementVector = np.array(movement)
